...
{{
  ...
  "matched_column": "<column of that same candidate, or an empty string for no_match>",
  "confidence": <float 0.0–1.0>
}}

IMPORTANT: matched_value must be copied verbatim from the candidate list.
matched_column must be copied from the SAME candidate's column label. If the
same value occurs in multiple columns, select the column supported by the
entity and candidate context; return no_match if the column is ambiguous.
