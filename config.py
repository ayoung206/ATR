...
``config_mapping`` is the kwargs passed to ``clients.chat_utils.get_chat_result``.
...
config_mapping = {
    ...
    "llama33": {
        ...
        "model": os.getenv(
            "VLLM_LLAMA33_MODEL", "llama-3.3-70b-instruct-awq"
        ),  # [paper] Table 4
        "api_key": "EMPTY",
    },
}
...
RERANK_CANDIDATE_MULTIPLIER: int = int(os.getenv("RERANK_CANDIDATE_MULTIPLIER", "6"))
